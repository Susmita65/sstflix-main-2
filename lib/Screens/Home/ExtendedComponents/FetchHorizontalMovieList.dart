...
import 'package:sstfix/Screens/CustomListFromUserHistory/Model/History.dart';
...
class _FetchHorizontalMovieListState extends State<FetchHorizontalMovieList> {
  ...
  Future fetchMovieData() async {
    ...
    final String url = "https://backend-clvt.onrender.com/watch/" + widget.id;
    try {
  ...
  Future postdata(movieid, moviename, posterpath) async {
    final String url = "https://backend-clvt.onrender.com/saved/" +
        widget.id +
        "/" +
        movieid.toString();
    dynamic dat = {
