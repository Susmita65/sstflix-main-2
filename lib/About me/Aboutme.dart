...
class _AboutmeState extends State<Aboutme> {
  List about = [
    ...
    "We made a Movie Recommendation API using Flask which is  used  into SSTFlix to recommend movies.",
    "Sentiment Analysis is used to analyse the sentiment of the movie reviews.",
    "We have  hosted the Flask api in render which returns a list of movies which we are using in suggest page",
  ];
  @override
